...
export default function Footer() {
  return (
    <footer className="bg-title text-white py-12">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="col-span-1 md:col-span-2">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-serif font-semibold text-xl">Lumière Clínica</span>
          </div>
          <p className="text-gray-300 max-w-sm mb-6">
            Especialistas em realçar sua beleza natural com procedimentos estéticos de alto padrão e tecnologia de ponta.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-12 pt-8 border-t border-gray-700 text-center text-sm text-gray-400">
        <p>© {new Date().getFullYear()} Lumière Clínica de Estética. Todos os direitos reservados.</p>
      </div>
    </footer>
  );
}
